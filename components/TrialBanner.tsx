...
export default function TrialBanner({ access, role }: { access: ClinicAccess; role: UserRole }) {
  ...
  if (access.status === "trialing") {
    return (
      <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 bg-rust-100 px-4 py-2 text-center text-sm text-brown-800">
        <span>
        ...
        {role === "owner" && (
          <Link href="/dashboard/settings#billing" className="font-medium text-rust-700 underline">
