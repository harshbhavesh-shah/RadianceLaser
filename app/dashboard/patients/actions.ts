...
import { getPatientsPage, searchPatients, type PatientsPage } from "@/lib/firestore/patients";
import type { Patient } from "@/types";

/** Fetches the next page of the clinic's patient roster — see
 * lib/firestore/patients.ts getPatientsPage. Called from PatientsTable's
 * "Load more" button. */
 ...
 * currently loaded) — see lib/firestore/patients.ts searchPatients. Called
