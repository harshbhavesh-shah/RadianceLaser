// AWS RDS's public global CA bundle, embedded directly rather than read
// from disk at runtime — see lib/db/client.ts for why. Source:
// https://truststore.pki.rds.amazonaws.com/global/global-bundle.pem
// Not a secret; safe to have in source control and in the client bundle.
export const RDS_GLOBAL_CA_BUNDLE = `
-----BEGIN CERTIFICATE-----
